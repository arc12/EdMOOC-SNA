...
Not all course participants are considered; only people who made a contribution to the forums appear. People may be "isolates" only if they made a post that never received a comment.
...
## Inspect Forums Except Introductions
```{r echo=FALSE, results='hide'}
# data for Introductions has I following the course names
group<-"noI"
```
