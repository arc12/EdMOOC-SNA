...
thd.thresh<-2 #numeric or use "" for no threshold (accident of history)
group<-thd.thresh
...
Not all course participants are considered; only people who made a contribution to the forums appear. People may be "isolates" only if they made the only post in a thread and it never received a comment.
